<?php
// source: /Applications/XAMPP/xamppfiles/htdocs/swi/sandbox/app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4763340786', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb064872248c_content')) { function _lb064872248c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb30b1d19613_title')) { function _lb30b1d19613_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lba332fdf6cf_scripts')) { function _lba332fdf6cf_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbfb9fe07d35_head')) { function _lbfb9fe07d35_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
